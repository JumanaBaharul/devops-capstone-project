...
![Build Status](https://github.com/JumanaBaharul/<REPOSITORY>/actions/workflows/<WORKFLOW_FILE>/badge.svg)

![Build Status](https://github.com/JumanaBaharul/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
